...
def create_h5(tsv, target, MAX_NUM_BOXES=128, WRITE_CHUNK=1024):
    with h5py.File(target, 'w', libver='latest')as hf:
        ...
        box_loc_h5ds = hf.create_dataset('box_loc/data', 
                                         shape=(WRITE_CHUNK, MAX_NUM_BOXES, 4), 
                                         chunks=(1, MAX_NUM_BOXES, 4), 
                                         maxshape=(None, MAX_NUM_BOXES, 4), 
                                         compression="lzf",
                                         dtype='f')
        ...
        def process_line(line):
            ...
            return num_boxes, box_loc, box_feat, class_label, query, other
        ...
        def flush_into_ds(hf, i, box_locs, box_feats, class_labels, querys, others):
            ...
            return (
                np.zeros((WRITE_CHUNK, MAX_NUM_BOXES, 4)), 
...
create_h5('../data/Kdd/train.sample.tsv', '../data/Kdd/train.sample.h5')
create_h5('../data/Kdd/train.tsv', '../data/Kdd/train.h5')
create_h5('../data/Kdd/valid.tsv', '../data/Kdd/valid.h5')
